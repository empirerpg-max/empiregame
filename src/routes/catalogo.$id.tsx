...
// COLE A MESMA NOVA URL DO WEB APP AQUI:
const GAS_URL = 'COLE_AQUI_A_NOVA_URL_DO_SEU_WEB_APP';
...
export default function CatalogoObraPage() {
  ...
  const enviarComentario = () => {
    ...
    // Mutação Otimista (Mostra na tela antes de salvar)
  ...
  return (
    <div className="bg-[#0f172a] min-h-screen text-white pb-24 relative">
      {/* Botão Voltar */}
      <button onClick={() => router.history.back()} className="absolute top-4 left-4 z-10 bg-black/50 p-2 rounded-full">
        ← Voltar
      </button>
      ...
      <div className="p-4 max-w-2xl mx-auto">
        ...
        {/* Input Fixado */}
        <div className="fixed bottom-0 left-0 w-full bg-[#1e2736] p-3 flex items-center gap-2 border-t border-gray-700">
          <input 
            type="text" 
